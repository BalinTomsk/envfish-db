...
-----------------------------------------------------------------------------------------------------------------------------------------------
-- fish_region_top seed : 63 regions (50 US states, 13 Canadian provinces/territories) x top-15
-- most-caught FRESHWATER species, ranked. Hand-curated per region (NOT sourced from
-- Top15_Fish_Canada_USA.xlsx - that workbook mixed salt/freshwater species for every coastal or
-- island region and named several entries as a group rather than a species, e.g. "Cisco",
-- "Grouper", "Sculpin", which left many regions short once filtered to freshwater-only: Hawaii had
-- zero resolvable freshwater species, Florida 4, Rhode Island 6).
--
-- Every one of the ~67 distinct species names here was pre-validated against a live copy of
-- dbo.fish (exact name match + water_type freshwater bit set) before being used, so this seed
-- resolves 945/945 with zero within-region duplicates. Must run AFTER the fish INSERT above in
-- this same file, not in script08_Data.sql - the fish_id resolution UPDATE below needs dbo.fish
-- populated, and the scripts concatenate in file order (script08 runs before script09).
--
-- Idempotent: safe to re-run (DELETE + reinsert + reresolve).
-----------------------------------------------------------------------------------------------------------------------------------------------
DELETE FROM dbo.fish_region_top;
GO

INSERT INTO dbo.fish_region_top (country, state, top_rank, common_name, fish_name) VALUES('CA', 'AB', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'AB', 2, 'Trout, Brown', 'Trout, Brown'),
('CA', 'AB', 3, 'Trout, Brook', 'Trout, Brook'),
('CA', 'AB', 4, 'Trout, Bull', 'Trout, Bull'),
('CA', 'AB', 5, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('CA', 'AB', 6, 'Trout, Lake', 'Trout, Lake'),
('CA', 'AB', 7, 'Walleye', 'Walleye'),
('CA', 'AB', 8, 'Pike, Northern', 'Pike, Northern'),
('CA', 'AB', 9, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'AB', 10, 'Goldeye', 'Goldeye'),
('CA', 'AB', 11, 'Burbot', 'Burbot'),
('CA', 'AB', 12, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'AB', 13, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('CA', 'AB', 14, 'Sauger', 'Sauger'),
('CA', 'AB', 15, 'Whitefish, Round', 'Whitefish, Round'),
('CA', 'BC', 1, 'Salmon, Chinook', 'Salmon, Chinook'),
('CA', 'BC', 2, 'Salmon, Coho', 'Salmon, Coho'),
('CA', 'BC', 3, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'BC', 4, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('CA', 'BC', 5, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('CA', 'BC', 6, 'Trout, Dolly Varden', 'Trout, Dolly Varden'),
('CA', 'BC', 7, 'Trout, Lake', 'Trout, Lake'),
('CA', 'BC', 8, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'BC', 9, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'BC', 10, 'Walleye', 'Walleye'),
('CA', 'BC', 11, 'Steelhead Trout', 'Steelhead Trout'),
('CA', 'BC', 12, 'Char, Arctic', 'Char, Arctic'),
('CA', 'BC', 13, 'Sturgeon, White', 'Sturgeon, White'),
('CA', 'BC', 14, 'Burbot', 'Burbot'),
('CA', 'BC', 15, 'Salmon, Pink', 'Salmon, Pink'),
('CA', 'MB', 1, 'Walleye', 'Walleye'),
('CA', 'MB', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'MB', 3, 'Trout, Lake', 'Trout, Lake'),
('CA', 'MB', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'MB', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'MB', 6, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'MB', 7, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'MB', 8, 'Sauger', 'Sauger'),
('CA', 'MB', 9, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'MB', 10, 'Burbot', 'Burbot'),
('CA', 'MB', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'MB', 12, 'Muskellunge', 'Muskellunge'),
('CA', 'MB', 13, 'Goldeye', 'Goldeye'),
('CA', 'MB', 14, 'Crappie, Black', 'Crappie, Black'),
('CA', 'MB', 15, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('CA', 'NB', 1, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('CA', 'NB', 2, 'Trout, Brook', 'Trout, Brook'),
('CA', 'NB', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'NB', 4, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'NB', 5, 'Bass, Striped', 'Bass, Striped'),
('CA', 'NB', 6, 'Pickerel, Chain', 'Pickerel, Chain'),
('CA', 'NB', 7, 'Trout, Brown', 'Trout, Brown'),
('CA', 'NB', 8, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'NB', 9, 'Shad, American', 'Shad, American'),
('CA', 'NB', 10, 'Alewife', 'Alewife'),
('CA', 'NB', 11, 'Perch, White', 'Perch, White'),
('CA', 'NB', 12, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'NB', 13, 'Pike, Northern', 'Pike, Northern'),
('CA', 'NB', 14, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'NB', 15, 'Muskellunge', 'Muskellunge'),
('CA', 'NL', 1, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('CA', 'NL', 2, 'Trout, Brook', 'Trout, Brook'),
('CA', 'NL', 3, 'Char, Arctic', 'Char, Arctic'),
('CA', 'NL', 4, 'Trout, Lake', 'Trout, Lake'),
('CA', 'NL', 5, 'Pike, Northern', 'Pike, Northern'),
('CA', 'NL', 6, 'Smelt, Rainbow', 'Smelt, Rainbow'),
('CA', 'NL', 7, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'NL', 8, 'Trout, Brown', 'Trout, Brown'),
('CA', 'NL', 9, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'NL', 10, 'Whitefish, Round', 'Whitefish, Round'),
('CA', 'NL', 11, 'Burbot', 'Burbot'),
('CA', 'NL', 12, 'Walleye', 'Walleye'),
('CA', 'NL', 13, 'Perch, White', 'Perch, White'),
('CA', 'NL', 14, 'Splake', 'Splake'),
('CA', 'NL', 15, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'NS', 1, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('CA', 'NS', 2, 'Trout, Brook', 'Trout, Brook'),
('CA', 'NS', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'NS', 4, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'NS', 5, 'Bass, Striped', 'Bass, Striped'),
('CA', 'NS', 6, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'NS', 7, 'Trout, Brown', 'Trout, Brown'),
('CA', 'NS', 8, 'Alewife', 'Alewife'),
('CA', 'NS', 9, 'Pickerel, Chain', 'Pickerel, Chain'),
('CA', 'NS', 10, 'Perch, White', 'Perch, White'),
('CA', 'NS', 11, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'NS', 12, 'Pike, Northern', 'Pike, Northern'),
('CA', 'NS', 13, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'NS', 14, 'Shad, American', 'Shad, American'),
('CA', 'NS', 15, 'Trout, Lake', 'Trout, Lake'),
('CA', 'NT', 1, 'Trout, Lake', 'Trout, Lake'),
('CA', 'NT', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'NT', 3, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'NT', 4, 'Inconnu', 'Inconnu'),
('CA', 'NT', 5, 'Char, Arctic', 'Char, Arctic'),
('CA', 'NT', 6, 'Burbot', 'Burbot'),
('CA', 'NT', 7, 'Walleye', 'Walleye'),
('CA', 'NT', 8, 'Trout, Dolly Varden', 'Trout, Dolly Varden'),
('CA', 'NT', 9, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'NT', 10, 'Goldeye', 'Goldeye'),
('CA', 'NT', 11, 'Chum Salmon', 'Chum Salmon'),
('CA', 'NT', 12, 'Whitefish, Round', 'Whitefish, Round'),
('CA', 'NT', 13, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('CA', 'NT', 14, 'Trout, Bull', 'Trout, Bull'),
('CA', 'NT', 15, 'Sucker, Longnose', 'Sucker, Longnose'),
('CA', 'NU', 1, 'Char, Arctic', 'Char, Arctic'),
('CA', 'NU', 2, 'Trout, Lake', 'Trout, Lake'),
('CA', 'NU', 3, 'Pike, Northern', 'Pike, Northern'),
('CA', 'NU', 4, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'NU', 5, 'Burbot', 'Burbot'),
('CA', 'NU', 6, 'Whitefish, Round', 'Whitefish, Round'),
('CA', 'NU', 7, 'Sucker, Longnose', 'Sucker, Longnose'),
('CA', 'NU', 8, 'Trout, Dolly Varden', 'Trout, Dolly Varden'),
('CA', 'NU', 9, 'Inconnu', 'Inconnu'),
('CA', 'NU', 10, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'NU', 11, 'Trout, Brook', 'Trout, Brook'),
('CA', 'NU', 12, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'NU', 13, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('CA', 'NU', 14, 'Walleye', 'Walleye'),
('CA', 'NU', 15, 'Goldeye', 'Goldeye'),
('CA', 'ON', 1, 'Walleye', 'Walleye'),
('CA', 'ON', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'ON', 3, 'Muskellunge', 'Muskellunge'),
('CA', 'ON', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'ON', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'ON', 6, 'Trout, Lake', 'Trout, Lake'),
('CA', 'ON', 7, 'Trout, Brook', 'Trout, Brook'),
('CA', 'ON', 8, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'ON', 9, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'ON', 10, 'Salmon, Chinook', 'Salmon, Chinook'),
('CA', 'ON', 11, 'Salmon, Coho', 'Salmon, Coho'),
('CA', 'ON', 12, 'Crappie, Black', 'Crappie, Black'),
('CA', 'ON', 13, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('CA', 'ON', 14, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'ON', 15, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'PE', 1, 'Trout, Brook', 'Trout, Brook'),
('CA', 'PE', 2, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('CA', 'PE', 3, 'Bass, Striped', 'Bass, Striped'),
('CA', 'PE', 4, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'PE', 5, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'PE', 6, 'Alewife', 'Alewife'),
('CA', 'PE', 7, 'Smelt, Rainbow', 'Smelt, Rainbow'),
('CA', 'PE', 8, 'Trout, Brown', 'Trout, Brown'),
('CA', 'PE', 9, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'PE', 10, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'PE', 11, 'Pickerel, Chain', 'Pickerel, Chain'),
('CA', 'PE', 12, 'Catfish, Channel', 'Catfish, Channel'),
('CA', 'PE', 13, 'Crappie, Black', 'Crappie, Black'),
('CA', 'PE', 14, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('CA', 'PE', 15, 'Perch, White', 'Perch, White'),
('CA', 'QC', 1, 'Walleye', 'Walleye'),
('CA', 'QC', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'QC', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'QC', 4, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'QC', 5, 'Trout, Lake', 'Trout, Lake'),
('CA', 'QC', 6, 'Trout, Brook', 'Trout, Brook'),
('CA', 'QC', 7, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'QC', 8, 'Muskellunge', 'Muskellunge'),
('CA', 'QC', 9, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('CA', 'QC', 10, 'Bass, Striped', 'Bass, Striped'),
('CA', 'QC', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'QC', 12, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'QC', 13, 'Crappie, Black', 'Crappie, Black'),
('CA', 'QC', 14, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('CA', 'QC', 15, 'Salmon, Chinook', 'Salmon, Chinook'),
('CA', 'SK', 1, 'Walleye', 'Walleye'),
('CA', 'SK', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'SK', 3, 'Trout, Lake', 'Trout, Lake'),
('CA', 'SK', 4, 'Perch, Yellow', 'Perch, Yellow'),
('CA', 'SK', 5, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'SK', 6, 'Burbot', 'Burbot'),
('CA', 'SK', 7, 'Goldeye', 'Goldeye'),
('CA', 'SK', 8, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'SK', 9, 'Trout, Brown', 'Trout, Brown'),
('CA', 'SK', 10, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('CA', 'SK', 11, 'Sauger', 'Sauger'),
('CA', 'SK', 12, 'Trout, Brook', 'Trout, Brook'),
('CA', 'SK', 13, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('CA', 'SK', 14, 'Bass, Largemouth', 'Bass, Largemouth'),
('CA', 'SK', 15, 'Crappie, Black', 'Crappie, Black'),
('CA', 'YT', 1, 'Trout, Lake', 'Trout, Lake'),
('CA', 'YT', 2, 'Pike, Northern', 'Pike, Northern'),
('CA', 'YT', 3, 'Trout, Dolly Varden', 'Trout, Dolly Varden'),
('CA', 'YT', 4, 'Salmon, Chinook', 'Salmon, Chinook'),
('CA', 'YT', 5, 'Chum Salmon', 'Chum Salmon'),
('CA', 'YT', 6, 'Whitefish, Lake', 'Whitefish, Lake'),
('CA', 'YT', 7, 'Burbot', 'Burbot'),
('CA', 'YT', 8, 'Trout, Rainbow', 'Trout, Rainbow'),
('CA', 'YT', 9, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('CA', 'YT', 10, 'Inconnu', 'Inconnu'),
('CA', 'YT', 11, 'Trout, Bull', 'Trout, Bull'),
('CA', 'YT', 12, 'Salmon, Coho', 'Salmon, Coho'),
('CA', 'YT', 13, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('CA', 'YT', 14, 'Char, Arctic', 'Char, Arctic'),
('CA', 'YT', 15, 'Whitefish, Round', 'Whitefish, Round'),
('US', 'AK', 1, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'AK', 2, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'AK', 3, 'Salmon, Pink', 'Salmon, Pink'),
('US', 'AK', 4, 'Chum Salmon', 'Chum Salmon'),
('US', 'AK', 5, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'AK', 6, 'Trout, Dolly Varden', 'Trout, Dolly Varden'),
('US', 'AK', 7, 'Trout, Lake', 'Trout, Lake'),
('US', 'AK', 8, 'Pike, Northern', 'Pike, Northern'),
('US', 'AK', 9, 'Burbot', 'Burbot'),
('US', 'AK', 10, 'Char, Arctic', 'Char, Arctic'),
('US', 'AK', 11, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'AK', 12, 'Steelhead Trout', 'Steelhead Trout'),
('US', 'AK', 13, 'Whitefish, Round', 'Whitefish, Round'),
('US', 'AK', 14, 'Inconnu', 'Inconnu'),
('US', 'AK', 15, 'Whitefish, Lake', 'Whitefish, Lake'),
('US', 'AL', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'AL', 2, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'AL', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'AL', 4, 'Alabama Bass', 'Alabama Bass'),
('US', 'AL', 5, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'AL', 6, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'AL', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'AL', 8, 'Crappie, White', 'Crappie, White'),
('US', 'AL', 9, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'AL', 10, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'AL', 11, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'AL', 12, 'Bass, Striped', 'Bass, Striped'),
('US', 'AL', 13, 'Bass, White', 'Bass, White'),
('US', 'AL', 14, 'Gar, Alligator', 'Gar, Alligator'),
('US', 'AL', 15, 'Bullhead, Yellow', 'Bullhead, Yellow'),
('US', 'AR', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'AR', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'AR', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'AR', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'AR', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'AR', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'AR', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'AR', 8, 'Bass, White', 'Bass, White'),
('US', 'AR', 9, 'Bass, Striped', 'Bass, Striped'),
('US', 'AR', 10, 'Walleye', 'Walleye'),
('US', 'AR', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'AR', 12, 'Trout, Brown', 'Trout, Brown'),
('US', 'AR', 13, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'AR', 14, 'Carp, Common', 'Carp, Common'),
('US', 'AR', 15, 'Crappie, White', 'Crappie, White'),
('US', 'AZ', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'AZ', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'AZ', 3, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'AZ', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'AZ', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'AZ', 6, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'AZ', 7, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'AZ', 8, 'Bass, Striped', 'Bass, Striped'),
('US', 'AZ', 9, 'Walleye', 'Walleye'),
('US', 'AZ', 10, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'AZ', 11, 'Trout, Apache', 'Trout, Apache'),
('US', 'AZ', 12, 'Tilapia', 'Tilapia'),
('US', 'AZ', 13, 'Carp, Common', 'Carp, Common'),
('US', 'AZ', 14, 'Bass, White', 'Bass, White'),
('US', 'AZ', 15, 'Sunfish, Green', 'Sunfish, Green'),
('US', 'CA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'CA', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'CA', 3, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'CA', 4, 'Bass, Striped', 'Bass, Striped'),
('US', 'CA', 5, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'CA', 6, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'CA', 7, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'CA', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'CA', 9, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'CA', 10, 'Sturgeon, White', 'Sturgeon, White'),
('US', 'CA', 11, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'CA', 12, 'Trout, Brown', 'Trout, Brown'),
('US', 'CA', 13, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'CA', 14, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'CA', 15, 'Trout, Lahontan cutthroat', 'Trout, Lahontan cutthroat'),
('US', 'CO', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'CO', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'CO', 3, 'Trout, Brook', 'Trout, Brook'),
('US', 'CO', 4, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'CO', 5, 'Trout, Lake', 'Trout, Lake'),
('US', 'CO', 6, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'CO', 7, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'CO', 8, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'CO', 9, 'Walleye', 'Walleye'),
('US', 'CO', 10, 'Pike, Northern', 'Pike, Northern'),
('US', 'CO', 11, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'CO', 12, 'Crappie, Black', 'Crappie, Black'),
('US', 'CO', 13, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'CO', 14, 'Bass, Striped', 'Bass, Striped'),
('US', 'CO', 15, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'CT', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'CT', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'CT', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'CT', 4, 'Trout, Brown', 'Trout, Brown'),
('US', 'CT', 5, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'CT', 6, 'Trout, Brook', 'Trout, Brook'),
('US', 'CT', 7, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'CT', 8, 'Pike, Northern', 'Pike, Northern'),
('US', 'CT', 9, 'Walleye', 'Walleye'),
('US', 'CT', 10, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'CT', 11, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'CT', 12, 'Crappie, Black', 'Crappie, Black'),
('US', 'CT', 13, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'CT', 14, 'Perch, White', 'Perch, White'),
('US', 'CT', 15, 'Trout, Lake', 'Trout, Lake'),
('US', 'DE', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'DE', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'DE', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'DE', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'DE', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'DE', 6, 'Perch, White', 'Perch, White'),
('US', 'DE', 7, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'DE', 8, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'DE', 9, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'DE', 10, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'DE', 11, 'Carp, Common', 'Carp, Common'),
('US', 'DE', 12, 'Bass, White', 'Bass, White'),
('US', 'DE', 13, 'Crappie, White', 'Crappie, White'),
('US', 'DE', 14, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'DE', 15, 'Bowfin', 'Bowfin'),
('US', 'FL', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'FL', 2, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'FL', 3, 'Crappie, Black', 'Crappie, Black'),
('US', 'FL', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'FL', 5, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'FL', 6, 'Bass, Striped', 'Bass, Striped'),
('US', 'FL', 7, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'FL', 8, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'FL', 9, 'Warmouth', 'Warmouth'),
('US', 'FL', 10, 'Gar, Florida', 'Gar, Florida'),
('US', 'FL', 11, 'Gar, Alligator', 'Gar, Alligator'),
('US', 'FL', 12, 'Bowfin', 'Bowfin'),
('US', 'FL', 13, 'Crappie, White', 'Crappie, White'),
('US', 'FL', 14, 'Carp, Grass', 'Carp, Grass'),
('US', 'FL', 15, 'Tilapia', 'Tilapia'),
('US', 'GA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'GA', 2, 'Bass, Striped', 'Bass, Striped'),
('US', 'GA', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'GA', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'GA', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'GA', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'GA', 7, 'Crappie, White', 'Crappie, White'),
('US', 'GA', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'GA', 9, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'GA', 10, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'GA', 11, 'Bass, White', 'Bass, White'),
('US', 'GA', 12, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'GA', 13, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'GA', 14, 'Trout, Brown', 'Trout, Brown'),
('US', 'GA', 15, 'Gar, Longnose', 'Gar, Longnose'),
('US', 'HI', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'HI', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'HI', 3, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'HI', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'HI', 5, 'Tilapia', 'Tilapia'),
('US', 'HI', 6, 'Carp, Common', 'Carp, Common'),
('US', 'HI', 7, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'HI', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'HI', 9, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'HI', 10, 'Carp, Grass', 'Carp, Grass'),
('US', 'HI', 11, 'Crappie, White', 'Crappie, White'),
('US', 'HI', 12, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'HI', 13, 'Bullhead, Yellow', 'Bullhead, Yellow'),
('US', 'HI', 14, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'HI', 15, 'Sunfish, Green', 'Sunfish, Green'),
('US', 'IA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'IA', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'IA', 3, 'Walleye', 'Walleye'),
('US', 'IA', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'IA', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'IA', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'IA', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'IA', 8, 'Bass, White', 'Bass, White'),
('US', 'IA', 9, 'Pike, Northern', 'Pike, Northern'),
('US', 'IA', 10, 'Muskellunge', 'Muskellunge'),
('US', 'IA', 11, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'IA', 12, 'Sauger', 'Sauger'),
('US', 'IA', 13, 'Carp, Common', 'Carp, Common'),
('US', 'IA', 14, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'IA', 15, 'Crappie, White', 'Crappie, White'),
('US', 'ID', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'ID', 2, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'ID', 3, 'Trout, Brown', 'Trout, Brown'),
('US', 'ID', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'ID', 5, 'Trout, Bull', 'Trout, Bull'),
('US', 'ID', 6, 'Trout, Lake', 'Trout, Lake'),
('US', 'ID', 7, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'ID', 8, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'ID', 9, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'ID', 10, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'ID', 11, 'Walleye', 'Walleye'),
('US', 'ID', 12, 'Pike, Northern', 'Pike, Northern'),
('US', 'ID', 13, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'ID', 14, 'Crappie, Black', 'Crappie, Black'),
('US', 'ID', 15, 'Steelhead Trout', 'Steelhead Trout'),
('US', 'IL', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'IL', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'IL', 3, 'Walleye', 'Walleye'),
('US', 'IL', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'IL', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'IL', 6, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'IL', 7, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'IL', 8, 'Bass, White', 'Bass, White'),
('US', 'IL', 9, 'Muskellunge', 'Muskellunge'),
('US', 'IL', 10, 'Pike, Northern', 'Pike, Northern'),
('US', 'IL', 11, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'IL', 12, 'Sauger', 'Sauger'),
('US', 'IL', 13, 'Carp, Common', 'Carp, Common'),
('US', 'IL', 14, 'Bass, Striped', 'Bass, Striped'),
('US', 'IL', 15, 'Crappie, White', 'Crappie, White'),
('US', 'IN', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'IN', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'IN', 3, 'Walleye', 'Walleye'),
('US', 'IN', 4, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'IN', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'IN', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'IN', 7, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'IN', 8, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'IN', 9, 'Pike, Northern', 'Pike, Northern'),
('US', 'IN', 10, 'Muskellunge', 'Muskellunge'),
('US', 'IN', 11, 'Bass, White', 'Bass, White'),
('US', 'IN', 12, 'Sauger', 'Sauger'),
('US', 'IN', 13, 'Carp, Common', 'Carp, Common'),
('US', 'IN', 14, 'Bass, Rock', 'Bass, Rock'),
('US', 'IN', 15, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'KS', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'KS', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'KS', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'KS', 4, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'KS', 5, 'Crappie, Black', 'Crappie, Black'),
('US', 'KS', 6, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'KS', 7, 'Bass, White', 'Bass, White'),
('US', 'KS', 8, 'Walleye', 'Walleye'),
('US', 'KS', 9, 'Bass, Striped', 'Bass, Striped'),
('US', 'KS', 10, 'Saugeye', 'Saugeye'),
('US', 'KS', 11, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'KS', 12, 'Carp, Common', 'Carp, Common'),
('US', 'KS', 13, 'Crappie, White', 'Crappie, White'),
('US', 'KS', 14, 'Drum, Freshwater', 'Drum, Freshwater'),
('US', 'KS', 15, 'Sauger', 'Sauger'),
('US', 'KY', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'KY', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'KY', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'KY', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'KY', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'KY', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'KY', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'KY', 8, 'Bass, White', 'Bass, White'),
('US', 'KY', 9, 'Sauger', 'Sauger'),
('US', 'KY', 10, 'Walleye', 'Walleye'),
('US', 'KY', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'KY', 12, 'Muskellunge', 'Muskellunge'),
('US', 'KY', 13, 'Bass, Striped', 'Bass, Striped'),
('US', 'KY', 14, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'KY', 15, 'Crappie, White', 'Crappie, White'),
('US', 'LA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'LA', 2, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'LA', 3, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'LA', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'LA', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'LA', 6, 'Bass, White', 'Bass, White'),
('US', 'LA', 7, 'Bass, Striped', 'Bass, Striped'),
('US', 'LA', 8, 'Crappie, White', 'Crappie, White'),
('US', 'LA', 9, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'LA', 10, 'Gar, Alligator', 'Gar, Alligator'),
('US', 'LA', 11, 'Bowfin', 'Bowfin'),
('US', 'LA', 12, 'Drum, Freshwater', 'Drum, Freshwater'),
('US', 'LA', 13, 'Bullhead, Black', 'Bullhead, Black'),
('US', 'LA', 14, 'Warmouth', 'Warmouth'),
('US', 'LA', 15, 'Paddlefish', 'Paddlefish'),
('US', 'MA', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'MA', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MA', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MA', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'MA', 5, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'MA', 6, 'Trout, Brown', 'Trout, Brown'),
('US', 'MA', 7, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'MA', 8, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'MA', 9, 'Perch, White', 'Perch, White'),
('US', 'MA', 10, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MA', 11, 'Crappie, Black', 'Crappie, Black'),
('US', 'MA', 12, 'Walleye', 'Walleye'),
('US', 'MA', 13, 'Pike, Northern', 'Pike, Northern'),
('US', 'MA', 14, 'Trout, Lake', 'Trout, Lake'),
('US', 'MA', 15, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MD', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'MD', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MD', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MD', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MD', 5, 'Perch, White', 'Perch, White'),
('US', 'MD', 6, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'MD', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'MD', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MD', 9, 'Northern snakehead', 'Northern snakehead'),
('US', 'MD', 10, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'MD', 11, 'Bass, White', 'Bass, White'),
('US', 'MD', 12, 'Crappie, White', 'Crappie, White'),
('US', 'MD', 13, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'MD', 14, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'MD', 15, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'ME', 1, 'Trout, Brook', 'Trout, Brook'),
('US', 'ME', 2, 'Trout, Lake', 'Trout, Lake'),
('US', 'ME', 3, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('US', 'ME', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'ME', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'ME', 6, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'ME', 7, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'ME', 8, 'Bass, Striped', 'Bass, Striped'),
('US', 'ME', 9, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'ME', 10, 'Trout, Brown', 'Trout, Brown'),
('US', 'ME', 11, 'Perch, White', 'Perch, White'),
('US', 'ME', 12, 'Pike, Northern', 'Pike, Northern'),
('US', 'ME', 13, 'Splake', 'Splake'),
('US', 'ME', 14, 'Walleye', 'Walleye'),
('US', 'ME', 15, 'Crappie, Black', 'Crappie, Black'),
('US', 'MI', 1, 'Walleye', 'Walleye'),
('US', 'MI', 2, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'MI', 3, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MI', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MI', 5, 'Pike, Northern', 'Pike, Northern'),
('US', 'MI', 6, 'Muskellunge', 'Muskellunge'),
('US', 'MI', 7, 'Trout, Lake', 'Trout, Lake'),
('US', 'MI', 8, 'Trout, Brown', 'Trout, Brown'),
('US', 'MI', 9, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'MI', 10, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'MI', 11, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'MI', 12, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MI', 13, 'Crappie, Black', 'Crappie, Black'),
('US', 'MI', 14, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MI', 15, 'Whitefish, Lake', 'Whitefish, Lake'),
('US', 'MN', 1, 'Walleye', 'Walleye'),
('US', 'MN', 2, 'Pike, Northern', 'Pike, Northern'),
('US', 'MN', 3, 'Muskellunge', 'Muskellunge'),
('US', 'MN', 4, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MN', 5, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MN', 6, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'MN', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MN', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'MN', 9, 'Trout, Lake', 'Trout, Lake'),
('US', 'MN', 10, 'Trout, Brown', 'Trout, Brown'),
('US', 'MN', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'MN', 12, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MN', 13, 'Sauger', 'Sauger'),
('US', 'MN', 14, 'Whitefish, Lake', 'Whitefish, Lake'),
('US', 'MN', 15, 'Sturgeon, Lake', 'Sturgeon, Lake'),
('US', 'MO', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MO', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MO', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'MO', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MO', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'MO', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'MO', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MO', 8, 'Bass, White', 'Bass, White'),
('US', 'MO', 9, 'Walleye', 'Walleye'),
('US', 'MO', 10, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'MO', 11, 'Paddlefish', 'Paddlefish'),
('US', 'MO', 12, 'Bass, Striped', 'Bass, Striped'),
('US', 'MO', 13, 'Carp, Common', 'Carp, Common'),
('US', 'MO', 14, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'MO', 15, 'Crappie, White', 'Crappie, White'),
('US', 'MS', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MS', 2, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MS', 3, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'MS', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'MS', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MS', 6, 'Bass, White', 'Bass, White'),
('US', 'MS', 7, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'MS', 8, 'Bass, Striped', 'Bass, Striped'),
('US', 'MS', 9, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'MS', 10, 'Crappie, White', 'Crappie, White'),
('US', 'MS', 11, 'Gar, Alligator', 'Gar, Alligator'),
('US', 'MS', 12, 'Bowfin', 'Bowfin'),
('US', 'MS', 13, 'Drum, Freshwater', 'Drum, Freshwater'),
('US', 'MS', 14, 'Carp, Common', 'Carp, Common'),
('US', 'MS', 15, 'Bullhead, Yellow', 'Bullhead, Yellow'),
('US', 'MT', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'MT', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'MT', 3, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'MT', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'MT', 5, 'Trout, Bull', 'Trout, Bull'),
('US', 'MT', 6, 'Trout, Lake', 'Trout, Lake'),
('US', 'MT', 7, 'Walleye', 'Walleye'),
('US', 'MT', 8, 'Pike, Northern', 'Pike, Northern'),
('US', 'MT', 9, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'MT', 10, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'MT', 11, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'MT', 12, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'MT', 13, 'Crappie, Black', 'Crappie, Black'),
('US', 'MT', 14, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'MT', 15, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NC', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NC', 2, 'Bass, Striped', 'Bass, Striped'),
('US', 'NC', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NC', 4, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'NC', 5, 'Crappie, Black', 'Crappie, Black'),
('US', 'NC', 6, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'NC', 7, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NC', 8, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NC', 9, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NC', 10, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'NC', 11, 'Trout, Brown', 'Trout, Brown'),
('US', 'NC', 12, 'Trout, Brook', 'Trout, Brook'),
('US', 'NC', 13, 'Crappie, White', 'Crappie, White'),
('US', 'NC', 14, 'Bass, White', 'Bass, White'),
('US', 'NC', 15, 'Gar, Longnose', 'Gar, Longnose'),
('US', 'ND', 1, 'Walleye', 'Walleye'),
('US', 'ND', 2, 'Pike, Northern', 'Pike, Northern'),
('US', 'ND', 3, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'ND', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'ND', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'ND', 6, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'ND', 7, 'Sauger', 'Sauger'),
('US', 'ND', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'ND', 9, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'ND', 10, 'Bass, White', 'Bass, White'),
('US', 'ND', 11, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'ND', 12, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'ND', 13, 'Carp, Common', 'Carp, Common'),
('US', 'ND', 14, 'Burbot', 'Burbot'),
('US', 'ND', 15, 'Muskellunge', 'Muskellunge'),
('US', 'NE', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NE', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NE', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NE', 4, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'NE', 5, 'Crappie, Black', 'Crappie, Black'),
('US', 'NE', 6, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'NE', 7, 'Bass, White', 'Bass, White'),
('US', 'NE', 8, 'Walleye', 'Walleye'),
('US', 'NE', 9, 'Pike, Northern', 'Pike, Northern'),
('US', 'NE', 10, 'Bass, Striped', 'Bass, Striped'),
('US', 'NE', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NE', 12, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NE', 13, 'Sauger', 'Sauger'),
('US', 'NE', 14, 'Carp, Common', 'Carp, Common'),
('US', 'NE', 15, 'Crappie, White', 'Crappie, White'),
('US', 'NH', 1, 'Trout, Brook', 'Trout, Brook'),
('US', 'NH', 2, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NH', 3, 'Trout, Brown', 'Trout, Brown'),
('US', 'NH', 4, 'Trout, Lake', 'Trout, Lake'),
('US', 'NH', 5, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('US', 'NH', 6, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NH', 7, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NH', 8, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'NH', 9, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NH', 10, 'Perch, White', 'Perch, White'),
('US', 'NH', 11, 'Pike, Northern', 'Pike, Northern'),
('US', 'NH', 12, 'Bass, Striped', 'Bass, Striped'),
('US', 'NH', 13, 'Crappie, Black', 'Crappie, Black'),
('US', 'NH', 14, 'Walleye', 'Walleye'),
('US', 'NH', 15, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NJ', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'NJ', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NJ', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NJ', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NJ', 5, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NJ', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'NJ', 7, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NJ', 8, 'Pike, Northern', 'Pike, Northern'),
('US', 'NJ', 9, 'Walleye', 'Walleye'),
('US', 'NJ', 10, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'NJ', 11, 'Trout, Brown', 'Trout, Brown'),
('US', 'NJ', 12, 'Crappie, White', 'Crappie, White'),
('US', 'NJ', 13, 'Perch, White', 'Perch, White'),
('US', 'NJ', 14, 'Muskellunge', 'Muskellunge'),
('US', 'NJ', 15, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'NM', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NM', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'NM', 3, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NM', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NM', 5, 'Walleye', 'Walleye'),
('US', 'NM', 6, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NM', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'NM', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'NM', 9, 'Pike, Northern', 'Pike, Northern'),
('US', 'NM', 10, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'NM', 11, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'NM', 12, 'Bass, White', 'Bass, White'),
('US', 'NM', 13, 'Bass, Striped', 'Bass, Striped'),
('US', 'NM', 14, 'Carp, Common', 'Carp, Common'),
('US', 'NM', 15, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'NV', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NV', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'NV', 3, 'Trout, Lahontan cutthroat', 'Trout, Lahontan cutthroat'),
('US', 'NV', 4, 'Trout, Lake', 'Trout, Lake'),
('US', 'NV', 5, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'NV', 6, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NV', 7, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NV', 8, 'Walleye', 'Walleye'),
('US', 'NV', 9, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NV', 10, 'Crappie, Black', 'Crappie, Black'),
('US', 'NV', 11, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'NV', 12, 'Bass, Striped', 'Bass, Striped'),
('US', 'NV', 13, 'Bass, White', 'Bass, White'),
('US', 'NV', 14, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'NV', 15, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'NY', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'NY', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'NY', 3, 'Walleye', 'Walleye'),
('US', 'NY', 4, 'Pike, Northern', 'Pike, Northern'),
('US', 'NY', 5, 'Muskellunge', 'Muskellunge'),
('US', 'NY', 6, 'Trout, Brown', 'Trout, Brown'),
('US', 'NY', 7, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'NY', 8, 'Trout, Brook', 'Trout, Brook'),
('US', 'NY', 9, 'Trout, Lake', 'Trout, Lake'),
('US', 'NY', 10, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'NY', 11, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'NY', 12, 'Bass, Striped', 'Bass, Striped'),
('US', 'NY', 13, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'NY', 14, 'Crappie, Black', 'Crappie, Black'),
('US', 'NY', 15, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'OH', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'OH', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'OH', 3, 'Walleye', 'Walleye'),
('US', 'OH', 4, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'OH', 5, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'OH', 6, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'OH', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'OH', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'OH', 9, 'Muskellunge', 'Muskellunge'),
('US', 'OH', 10, 'Sauger', 'Sauger'),
('US', 'OH', 11, 'Bass, White', 'Bass, White'),
('US', 'OH', 12, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'OH', 13, 'Pike, Northern', 'Pike, Northern'),
('US', 'OH', 14, 'Saugeye', 'Saugeye'),
('US', 'OH', 15, 'Carp, Common', 'Carp, Common'),
('US', 'OK', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'OK', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'OK', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'OK', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'OK', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'OK', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'OK', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'OK', 8, 'Bass, White', 'Bass, White'),
('US', 'OK', 9, 'Bass, Striped', 'Bass, Striped'),
('US', 'OK', 10, 'Walleye', 'Walleye'),
('US', 'OK', 11, 'Paddlefish', 'Paddlefish'),
('US', 'OK', 12, 'Sauger', 'Sauger'),
('US', 'OK', 13, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'OK', 14, 'Crappie, White', 'Crappie, White'),
('US', 'OK', 15, 'Carp, Common', 'Carp, Common'),
('US', 'OR', 1, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'OR', 2, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'OR', 3, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'OR', 4, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'OR', 5, 'Trout, Brown', 'Trout, Brown'),
('US', 'OR', 6, 'Trout, Lake', 'Trout, Lake'),
('US', 'OR', 7, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'OR', 8, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'OR', 9, 'Walleye', 'Walleye'),
('US', 'OR', 10, 'Crappie, Black', 'Crappie, Black'),
('US', 'OR', 11, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'OR', 12, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'OR', 13, 'Sturgeon, White', 'Sturgeon, White'),
('US', 'OR', 14, 'Steelhead Trout', 'Steelhead Trout'),
('US', 'OR', 15, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'PA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'PA', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'PA', 3, 'Walleye', 'Walleye'),
('US', 'PA', 4, 'Muskellunge', 'Muskellunge'),
('US', 'PA', 5, 'Pike, Northern', 'Pike, Northern'),
('US', 'PA', 6, 'Trout, Brown', 'Trout, Brown'),
('US', 'PA', 7, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'PA', 8, 'Trout, Brook', 'Trout, Brook'),
('US', 'PA', 9, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'PA', 10, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'PA', 11, 'Crappie, Black', 'Crappie, Black'),
('US', 'PA', 12, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'PA', 13, 'Bass, Striped', 'Bass, Striped'),
('US', 'PA', 14, 'Carp, Common', 'Carp, Common'),
('US', 'PA', 15, 'Trout, Lake', 'Trout, Lake'),
('US', 'RI', 1, 'Bass, Striped', 'Bass, Striped'),
('US', 'RI', 2, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'RI', 3, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'RI', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'RI', 5, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'RI', 6, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'RI', 7, 'Trout, Brown', 'Trout, Brown'),
('US', 'RI', 8, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'RI', 9, 'Crappie, Black', 'Crappie, Black'),
('US', 'RI', 10, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'RI', 11, 'Walleye', 'Walleye'),
('US', 'RI', 12, 'Pike, Northern', 'Pike, Northern'),
('US', 'RI', 13, 'Perch, White', 'Perch, White'),
('US', 'RI', 14, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'RI', 15, 'Bass, White', 'Bass, White'),
('US', 'SC', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'SC', 2, 'Bass, Striped', 'Bass, Striped'),
('US', 'SC', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'SC', 4, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'SC', 5, 'Crappie, Black', 'Crappie, Black'),
('US', 'SC', 6, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'SC', 7, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'SC', 8, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'SC', 9, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'SC', 10, 'Crappie, White', 'Crappie, White'),
('US', 'SC', 11, 'Bass, White', 'Bass, White'),
('US', 'SC', 12, 'Bowfin', 'Bowfin'),
('US', 'SC', 13, 'Gar, Longnose', 'Gar, Longnose'),
('US', 'SC', 14, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'SC', 15, 'Carp, Common', 'Carp, Common'),
('US', 'SD', 1, 'Walleye', 'Walleye'),
('US', 'SD', 2, 'Pike, Northern', 'Pike, Northern'),
('US', 'SD', 3, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'SD', 4, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'SD', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'SD', 6, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'SD', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'SD', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'SD', 9, 'Bass, White', 'Bass, White'),
('US', 'SD', 10, 'Sauger', 'Sauger'),
('US', 'SD', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'SD', 12, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'SD', 13, 'Carp, Common', 'Carp, Common'),
('US', 'SD', 14, 'Paddlefish', 'Paddlefish'),
('US', 'SD', 15, 'Crappie, White', 'Crappie, White'),
('US', 'TN', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'TN', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'TN', 3, 'Bass, Spotted', 'Bass, Spotted'),
('US', 'TN', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'TN', 5, 'Crappie, Black', 'Crappie, Black'),
('US', 'TN', 6, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'TN', 7, 'Bass, White', 'Bass, White'),
('US', 'TN', 8, 'Bass, Striped', 'Bass, Striped'),
('US', 'TN', 9, 'Walleye', 'Walleye'),
('US', 'TN', 10, 'Sauger', 'Sauger'),
('US', 'TN', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'TN', 12, 'Trout, Brown', 'Trout, Brown'),
('US', 'TN', 13, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'TN', 14, 'Carp, Common', 'Carp, Common'),
('US', 'TN', 15, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'TX', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'TX', 2, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'TX', 3, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'TX', 4, 'Crappie, Black', 'Crappie, Black'),
('US', 'TX', 5, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'TX', 6, 'Bass, White', 'Bass, White'),
('US', 'TX', 7, 'Bass, Striped', 'Bass, Striped'),
('US', 'TX', 8, 'Gar, Alligator', 'Gar, Alligator'),
('US', 'TX', 9, 'Bass, Guadalupe', 'Bass, Guadalupe'),
('US', 'TX', 10, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'TX', 11, 'Crappie, White', 'Crappie, White'),
('US', 'TX', 12, 'Sunfish, Redear', 'Sunfish, Redear'),
('US', 'TX', 13, 'Carp, Common', 'Carp, Common'),
('US', 'TX', 14, 'Paddlefish', 'Paddlefish'),
('US', 'TX', 15, 'Tilapia', 'Tilapia'),
('US', 'UT', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'UT', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'UT', 3, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'UT', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'UT', 5, 'Trout, Lake', 'Trout, Lake'),
('US', 'UT', 6, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'UT', 7, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'UT', 8, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'UT', 9, 'Walleye', 'Walleye'),
('US', 'UT', 10, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'UT', 11, 'Crappie, Black', 'Crappie, Black'),
('US', 'UT', 12, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'UT', 13, 'Bass, Striped', 'Bass, Striped'),
('US', 'UT', 14, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'UT', 15, 'Muskellunge, Tiger', 'Muskellunge, Tiger'),
('US', 'VA', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'VA', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'VA', 3, 'Bass, Striped', 'Bass, Striped'),
('US', 'VA', 4, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'VA', 5, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'VA', 6, 'Crappie, Black', 'Crappie, Black'),
('US', 'VA', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'VA', 8, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'VA', 9, 'Muskellunge', 'Muskellunge'),
('US', 'VA', 10, 'Trout, Brook', 'Trout, Brook'),
('US', 'VA', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'VA', 12, 'Trout, Brown', 'Trout, Brown'),
('US', 'VA', 13, 'Sunfish, Redbreast', 'Sunfish, Redbreast'),
('US', 'VA', 14, 'Crappie, White', 'Crappie, White'),
('US', 'VA', 15, 'Carp, Common', 'Carp, Common'),
('US', 'VT', 1, 'Trout, Brook', 'Trout, Brook'),
('US', 'VT', 2, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'VT', 3, 'Trout, Brown', 'Trout, Brown'),
('US', 'VT', 4, 'Trout, Lake', 'Trout, Lake'),
('US', 'VT', 5, 'Salmon, Atlantic', 'Salmon, Atlantic'),
('US', 'VT', 6, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'VT', 7, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'VT', 8, 'Pike, Northern', 'Pike, Northern'),
('US', 'VT', 9, 'Walleye', 'Walleye'),
('US', 'VT', 10, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'VT', 11, 'Pickerel, Chain', 'Pickerel, Chain'),
('US', 'VT', 12, 'Crappie, Black', 'Crappie, Black'),
('US', 'VT', 13, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'VT', 14, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'VT', 15, 'Muskellunge', 'Muskellunge'),
('US', 'WA', 1, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'WA', 2, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'WA', 3, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'WA', 4, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'WA', 5, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'WA', 6, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'WA', 7, 'Walleye', 'Walleye'),
('US', 'WA', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'WA', 9, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'WA', 10, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'WA', 11, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'WA', 12, 'Steelhead Trout', 'Steelhead Trout'),
('US', 'WA', 13, 'Sturgeon, White', 'Sturgeon, White'),
('US', 'WA', 14, 'Salmon, Pink', 'Salmon, Pink'),
('US', 'WA', 15, 'Trout, Brown', 'Trout, Brown'),
('US', 'WI', 1, 'Walleye', 'Walleye'),
('US', 'WI', 2, 'Muskellunge', 'Muskellunge'),
('US', 'WI', 3, 'Pike, Northern', 'Pike, Northern'),
('US', 'WI', 4, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'WI', 5, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'WI', 6, 'Perch, Yellow', 'Perch, Yellow'),
('US', 'WI', 7, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'WI', 8, 'Crappie, Black', 'Crappie, Black'),
('US', 'WI', 9, 'Trout, Lake', 'Trout, Lake'),
('US', 'WI', 10, 'Trout, Brown', 'Trout, Brown'),
('US', 'WI', 11, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'WI', 12, 'Salmon, Chinook', 'Salmon, Chinook'),
('US', 'WI', 13, 'Salmon, Coho', 'Salmon, Coho'),
('US', 'WI', 14, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'WI', 15, 'Whitefish, Lake', 'Whitefish, Lake'),
('US', 'WV', 1, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'WV', 2, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'WV', 3, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'WV', 4, 'Catfish, Flathead', 'Catfish, Flathead'),
('US', 'WV', 5, 'Muskellunge', 'Muskellunge'),
('US', 'WV', 6, 'Walleye', 'Walleye'),
('US', 'WV', 7, 'Crappie, Black', 'Crappie, Black'),
('US', 'WV', 8, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'WV', 9, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'WV', 10, 'Trout, Brown', 'Trout, Brown'),
('US', 'WV', 11, 'Trout, Brook', 'Trout, Brook'),
('US', 'WV', 12, 'Pike, Northern', 'Pike, Northern'),
('US', 'WV', 13, 'Bass, Rock', 'Bass, Rock'),
('US', 'WV', 14, 'Carp, Common', 'Carp, Common'),
('US', 'WV', 15, 'Sauger', 'Sauger'),
('US', 'WY', 1, 'Trout, Rainbow', 'Trout, Rainbow'),
('US', 'WY', 2, 'Trout, Brown', 'Trout, Brown'),
('US', 'WY', 3, 'Trout, Cutthroat', 'Trout, Cutthroat'),
('US', 'WY', 4, 'Trout, Brook', 'Trout, Brook'),
('US', 'WY', 5, 'Trout, Lake', 'Trout, Lake'),
('US', 'WY', 6, 'Salmon, Kokanee', 'Salmon, Kokanee'),
('US', 'WY', 7, 'Walleye', 'Walleye'),
('US', 'WY', 8, 'Bass, Largemouth', 'Bass, Largemouth'),
('US', 'WY', 9, 'Bass, Smallmouth', 'Bass, Smallmouth'),
('US', 'WY', 10, 'Pike, Northern', 'Pike, Northern'),
('US', 'WY', 11, 'Catfish, Channel', 'Catfish, Channel'),
('US', 'WY', 12, 'Crappie, Black', 'Crappie, Black'),
('US', 'WY', 13, 'Sunfish, Bluegill', 'Sunfish, Bluegill'),
('US', 'WY', 14, 'Burbot', 'Burbot'),
('US', 'WY', 15, 'Sauger', 'Sauger');
GO

-- fish_id is not hardcoded (GUIDs differ per database) - resolve by exact fish_name match, same
-- pattern as the fish INSERT above.
UPDATE t
   SET t.fish_id = f.fish_id
  FROM dbo.fish_region_top t
  JOIN dbo.fish f ON f.fish_name = t.fish_name
 WHERE t.fish_name IS NOT NULL;
GO
